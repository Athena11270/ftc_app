...
// */
//
//public class TankDrivetrain6 extends Drivetrain implements Rotatable, Positionable {
//    private double rotation = 0;
//
//    private double targetPosition = 0;
//
//    private DcMotor.RunMode[] runModes = new DcMotor.RunMode[6];
//
//    private double[] wheelTargetPositions = new double[6];
//
...
//     */
//    public TankDrivetrain6(DcMotor[] motors, DcMotor ML, DcMotor MR) {
//        super(motors);
//        left = ML;
//        right = MR;
//    }
//
////    public TankDrivetrain6(DcMotor motor1, DcMotor motor2) {
...
//        if (left.isBusy() || right.isBusy()) return true;
//        else return false;
//    }
//
//    /**
